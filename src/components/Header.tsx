...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-slate-50 px-4 py-1.5 text-xs flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 ">
        {" "}
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        {currentUser && (
          <nav
            className="flex flex-wrap items-center bg-slate-100 /60 p-1 border border-slate-200 rounded-xl shadow-inner"
            id="main_navigation"
          >
            {" "}
            <button
